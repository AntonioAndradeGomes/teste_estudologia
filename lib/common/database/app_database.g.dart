    ...
    final databaseOptions = sqflite.OpenDatabaseOptions(
      ...
      onCreate: (database, version) async {
        await database.execute(
            'CREATE TABLE IF NOT EXISTS `task` (`id` INTEGER, `content` TEXT, `description` TEXT, `createdAt` TEXT, `taskCompletionDate` TEXT, PRIMARY KEY (`id`))');
  ...
  Future<List<TaskModel>> getAllTasks() async {
    return _queryAdapter.queryList('SELECT * FROM task',
        mapper: (Map<String, Object?> row) => TaskModel(
            ...
            taskCompletionDate: row['taskCompletionDate'] as String?));
  }
